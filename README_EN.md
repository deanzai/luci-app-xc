...
The current source package version is `0.1.0-r14`; a typical artifact is:

```text
bin/packages/**/luci-app-xc_0.1.0-r14_all.ipk
```
...
mistaken for one another. It also normalizes the control metadata version to `0.1.0-r14`
so opkg can upgrade installations reporting the older `0.1.0-10` version:

```text
21.02: luci-app-xc_0.1.0-r14_all_openwrt-21.02.ipk
23.05: luci-app-xc_0.1.0-r14_all_openwrt-23.05.ipk
24.10: luci-app-xc_0.1.0-r14_all_openwrt-24.10.ipk
```

Translation packages use the LuCI PO version independently and receive the same suffix:

```text
luci-i18n-xc-zh-cn_0.1.0-r14_all_openwrt-21.02.ipk
luci-i18n-xc-zh-cn_0.1.0-r14_all_openwrt-23.05.ipk
luci-i18n-xc-zh-cn_0.1.0-r14_all_openwrt-24.10.ipk
```
...
```sh
opkg install /tmp/luci-app-xc_0.1.0-r14_all.ipk /tmp/luci-i18n-xc-zh-cn_0.1.0-r14_all.ipk
```
